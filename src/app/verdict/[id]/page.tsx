      ...
      <header className="border-b border-court-800 relative z-10">
        <div className="max-w-4xl mx-auto px-6 py-3 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="font-display text-sm text-court-300 group-hover:text-court-100 transition-colors tracking-wider">Feature Court</span>
          </Link>
            ...
            <div className={`verdict-certificate verdict-certificate-${ruling} p-6 md:p-8 overflow-hidden ${ceremony.gavel ? "" : "opacity-0"} transition-opacity duration-1000`}>
              ...
              <div className={`text-center border-b border-court-700 pb-5 mb-6 transition-all duration-1000 relative z-10 ${ceremony.gavel ? "opacity-100" : "opacity-0"}`}>
                <div className="flex items-center justify-center gap-2 mb-3">
                  ...
                  <div>
                    <p className="font-display text-base text-court-100 tracking-wider">Feature Court</p>
              ...
              <div className={`text-center mb-5 transition-all duration-1000 delay-200 relative z-10 ${ceremony.gavel ? "opacity-100" : "opacity-0"}`}>
                <h1 className="font-display text-xl sm:text-2xl font-normal tracking-[0.04em] text-court-100 leading-tight">
                  {trial.case_title}
                </h1>
              </div>
