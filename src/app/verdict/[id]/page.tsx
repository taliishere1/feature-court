...
export default function VerdictPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function load() {
      ...
      setLoading(false);
      if (r === "ship") setShowConfetti(true);
    }
    load();
  }, [params]);
      ...
      <main className="flex-1 px-6 py-10 flex items-center justify-center relative z-10">
        <div className="max-w-xl w-full">
          {/* Official Verdict Certificate */}
            <div className={`verdict-certificate verdict-certificate-${ruling} p-4 md:p-6 overflow-hidden`}>
              ...
              {/* Letterhead */}
              <div className="text-center border-b border-court-700 pb-4 mb-4 relative z-10">
              ...
              <div className="text-center py-5 relative z-10">
                <div className={`inline-block ${RULING_BG[ruling]} border-2 ${RULING_COLORS[ruling]} px-10 py-4 rounded-sm`}>
              ...
              {/* Verdict details */}
              <div className="border-t border-court-700 pt-5 space-y-4 relative z-10">
              ...
              {/* Gut call note */}
              {gutMismatch && (
                <div className="border-t border-court-700 pt-4 mt-5 text-center relative z-10">
              ...
              {/* Footer */}
              <div className="border-t border-court-700 pt-4 mt-5 flex items-center justify-between relative z-10">
