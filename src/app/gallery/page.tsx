      ...
      <main className="flex-1 px-6 py-16 relative z-10">
        <div className="max-w-6xl mx-auto animate-page-enter">
          ...
          {loading ? (
            ...
            <div className="text-center py-20 border border-dashed border-court-700 rounded-sm max-w-lg mx-auto parchment">
              <div className="mb-4">
              ...
              <p className="text-court-500 font-serif text-lg mb-2">The docket is empty</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {trials.map((trial, i) => (
                ...
                >
                  ...
                  <p className="font-serif text-court-100 font-bold text-base mb-2 leading-snug group-hover:text-gold-200 transition-colors">
                    {trial.case_title}
                  </p>
                  <p className="text-court-500 text-xs leading-relaxed mb-3 line-clamp-2 font-legal">
                    {trial.intake.proposal}
                  </p>
                  <div className="flex items-center gap-2 pt-2 border-t border-court-800">
